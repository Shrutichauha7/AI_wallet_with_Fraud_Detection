...
class TrainPipeline:
    ...
    def start_model_trainer(
        ...
        try:
            ...
            import os  # (safe to keep here or at top)

            if not os.path.exists(
                data_transformation_artifact.transformed_train_file_path
            ):
                raise Exception("Transformed train file not found.")
            ...
            logging.info(
                f"Model saved at: {model_trainer_artifact.trained_model_file_path}"
            )
    ...
    def start_model_evaluation(
        ...
        try:
            logging.info("Entered start_model_evaluation method")
